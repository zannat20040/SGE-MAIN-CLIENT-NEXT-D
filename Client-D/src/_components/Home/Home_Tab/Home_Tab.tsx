...
import partners from '/public/assets/Homepage/For-Partners-Icon.png'
import students from '/public/assets/Homepage/For-Students-Icon.png'
            ...
            <div className="tab-content tab-1 color_div text-center lg:text-left mb-[56px] pt-[50px] md:pt-[150px] lg:pt-0">
                ...
                <div className='flex flex-col lg:flex-row justify-between gap-[28px] items-center'>
                    ...
                    <div className='order-1 lg:order-2 lg:pt-0 md:pt-10'>
                        <Image width={100} height={100} className='w-[200px] md:w-[300px] lg:w-[447px] md:mx-auto' src={students} alt="students" />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div className="tab-content tab-2 color_div text-center lg:text-left  pt-[50px] md:pt-[150px] lg:pt-0">
                ...
                <div className='flex flex-col lg:flex-row justify-between gap-[28px] items-center'>
                    <div className='order-2 lg:order-1 text-center lg:text-left'>
                        ...
                        <Link href={"/comingSoon"}><button className='bg-[#2563EB] hover:bg-[#126def] mulish-regular lg:text-[21px] text-[14px] text-white rounded-[32px] lg:px-[85px] px-10 lg:py-2 py-[8px] mt-6'>Explore More</button></Link>
                    </div>
                    <div className='order-1 lg:order-2'>
                        <Image  width={100} height={100} className='w-[148px] md:w-[298px] lg:w-[447px] mx-auto' src={partners} alt="partners" />
                    </div>
                </div>
            </div>
        </div>
