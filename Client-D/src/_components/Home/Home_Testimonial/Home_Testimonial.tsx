            ...
            {sliders.map((slide, inx) => (
              ...
              >
                <Image
                  width={100}
                  height={100}
                  className="absolute w-fit md:w-1/6 h-auto lg:top-8 top-2 md:top-4 left-2 md:left-10 lg:left-8"
                ...
                <Image
                  ...
                  height={100}
                  src={slide.img}
                  className="mx-auto mt-10 lg:mt-16 h-40 w-auto  object-cover rounded-xl"
                  alt={slide.name}
                />
