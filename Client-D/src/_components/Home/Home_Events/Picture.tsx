...
import event1 from "../../../../public/assets/Homepage/upcoming-events/event1.webp";
import event2 from "../../../../public/assets/Homepage/upcoming-events/event2.webp";
import event3 from "../../../../public/assets/Homepage/upcoming-events/event3.webp";
import event4 from "../../../../public/assets/Homepage/upcoming-events/event4.webp";
import event5 from "../../../../public/assets/Homepage/upcoming-events/event5.webp";

const Picture = () => {
  function slideNext() {
    const $slide_pos_center =
      document.getElementsByClassName("slide-pos-center")[0];
    const $slide_pos_left1 =
      document.getElementsByClassName("slide-pos-left1")[0];
    const $slide_pos_left2 =
      document.getElementsByClassName("slide-pos-left2")[0];
    const $slide_pos_right2 =
      document.getElementsByClassName("slide-pos-right2")[0];
    const $slide_pos_right1 =
      document.getElementsByClassName("slide-pos-right1")[0];
    ...
    <div className="events-bg max-w-[1254px]  mx-auto relative pl-[50px] pr-[50px]">
      <div className="absolute left-[50%] -translate-x-1/2 slide-pos-center carousel-1 w-full ">
        <picture>
          <source
            ...
            srcSet="assets/Homepage/upcoming-events/pastevent1.png"
          ></source>
          <source
            media="(max-width : 768px)"
            srcSet="assets/Homepage/upcoming-events/pastevent1.png"
          ></source>
          <Image src={event1} alt="event1pic" onClick={slideNext} priority/>
        </picture>
      </div>
      <div className="absolute left-[50%] -translate-x-1/2 slide-pos-right1 carousel-1 w-full">
        <picture>
          <source
            media="(max-width : 640px)"
            srcSet="assets/Homepage/upcoming-events/pastevent2.png"
          ></source>
          <source
            media="(max-width : 768px)"
            srcSet="assets/Homepage/upcoming-events/pastevent2.png"
          ></source>
          <Image src={event2} alt="event2pic" onClick={slideNext} priority />
        </picture>
      </div>
      <div className="absolute left-[50%] -translate-x-1/2 slide-pos-right2 carousel-1 w-full">
        <picture>
          <source
            media="(max-width : 640px, maxhe)"
            srcSet="assets/Homepage/upcoming-events/pastevent3.png"
          ></source>
          <source
            media="(max-width : 768px)"
            srcSet="assets/Homepage/upcoming-events/pastevent3.png"
          ></source>
          <Image src={event3} alt="event3pic" onClick={slideNext} priority />
        </picture>
      </div>
      <div className="absolute left-[50%] -translate-x-1/2 slide-pos-left1 carousel-1 w-full">
        <picture>
          <source
            media="(max-width : 640px)"
            srcSet="assets/Homepage/upcoming-events/pastevent4.png"
          ></source>
          <source
            media="(max-width : 768px)"
            srcSet="assets/Homepage/upcoming-events/pastevent4.png"
          ></source>
          <Image src={event4} alt="event4pic" onClick={slideNext} priority/>
        </picture>
      </div>
      <div className="absolute left-[50%] -translate-x-1/2 slide-pos-left2 carousel-1  w-full">
        <picture>
          <source
            media="(max-width : 640px)"
            srcSet="assets/Homepage/upcoming-events/pastevent5.png"
          ></source>
          <source
            media="(max-width : 768px)"
            srcSet="assets/Homepage/upcoming-events/pastevent5.png"
          ></source>
          <Image src={event5} alt="event5pic" onClick={slideNext} priority />
        </picture>
      </div>

      <button
        className="absolute lg:flex hidden items-center lg:top-60 lg:left-0 button-one-next"
        onClick={slideNext}
      >
        <svg
          width="36"
      ...
      <button
        className="absolute lg:block hidden z-10 lg:right-0 lg:top-60 button-one-prev"
        onClick={slidePrev}
      >
        <svg
          width="36"
      ...
      <button
        className="absolute lg:hidden block z-10 top-[440px] left-52 md:left-[400px]"
        onClick={slideNext}
      >
        <svg
          width="42"
        ...
        >
          <rect
            ...
            height="41.087"
            rx="20.5435"
            transform="rotate(-90 0.456522 41.5435)"
            fill="white"
          />
          <rect
            x="0.456522"
      ...
      <button
        className="absolute lg:hidden block top-[440px] left-40 md:left-[335px]"
        onClick={slidePrev}
      >
        <svg
          width="42"
        ...
        >
          <rect
            ...
            height="41.087"
            rx="20.5435"
            transform="rotate(90 41.5435 0.456522)"
            fill="white"
          />
          <rect
            x="41.5435"
