    ...
    <div className="max-w-[1152px] mx-auto pb-[120px] pt-[96px] relative">
      <div className="absolute top-3 -left-36 -z-10 lg:block md:hidden hidden">
        <Image
          ...
          width={371}
          height={359}
          src="/assets/About Us/4. Meet our Founder/084.webp"
          className="p-[31px] mx-auto w-auto h-auto rounded-[32px]"
          alt="image"
        />
      </div>
      <div className="lg:px-[98px] md:px-12 px-8">
        <div className="text-center">
          ...
          <h3 className="poppins-semibold lg:text-[40px] text-[28px] text-[#081831] leading-[56px] -tracking-[0.02em] pb-[55px]">
            The visionary, inspiring global goals
          </h3>
        </div>
        <div className="flex shadow-about rounded-[32px] lg:flex-row flex-col items-center">
          <div className="lg:w-[28%] w-full rounded-md">
            <Image
              priority
              width={100}
              height={100}
              src="/assets/About Us/4. Meet our Founder/MD Zahidul Alam.webp"
              className="p-[31px] mx-auto w-auto h-auto rounded-md"
              alt="image"
            />
          </div>
          <div className="lg:w-[72%] w-full lg:pr-[34px] lg:py-3 p-6">
            <div className="flex justify-between items-center ">
              <h2 className="poppins-semibold text-[28px] text-[#081831]">
                MD. Zahidul Alam
              </h2>
              <svg
                width="25"
                ...
                <defs>
                  <clipPath id="clip0_1_2055">
                    <rect
                      ...
                      height="24"
                      fill="white"
                      transform="translate(0.545898 -0.000457764)"
                    />
                  </clipPath>
                </defs>
              </svg>
            </div>
            <h3 className="poppins-bold text-[20px] tracker-[0.01em] text-[#4B4B4B]">
              CEO
            </h3>
            <p className="poppins-regular text-[16px] text-[#000000] pt-7 text-justify ">
              Fifteen years ago, an enlightened visionary conceived Shabuj
              Global Education to simplify the daunting process of studying
              abroad. His goal is to help students explore global opportunities
              and access quality education. Today, he proudly supports thousands
              of students who have realized their dreams.
            </p>
          </div>
        </div>
      </div>
