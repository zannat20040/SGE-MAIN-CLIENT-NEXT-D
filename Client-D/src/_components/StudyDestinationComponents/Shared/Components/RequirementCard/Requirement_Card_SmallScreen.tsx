    ...
    <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-8 pt-24 pb-36">
        ...
        <div>
          ...
          >
            <Image width={100} height={100}
              src='/assets/UK Page/4. Requirements Section/49 a 1-1-min.png'
              alt="Diploma"
      ...
      >
        ...
        <div>
          ...
          >
            <Image width={100} height={100}
              src="/assets/UK Page/4. Requirements Section/49 a 1-3-min.png"
              alt="Diploma"
              className="object-cover h-auto w-auto group-hover:scale-125"
            />
          </motion.div>
      ...
      >
        ...
        >
          <Image width={100} height={100}
            src="/assets/UK Page/4. Requirements Section/49 a 1-2-min.png"
            alt="Diploma"
            className="object-cover h-auto w-auto group-hover:scale-125"
          />
        </motion.div>
