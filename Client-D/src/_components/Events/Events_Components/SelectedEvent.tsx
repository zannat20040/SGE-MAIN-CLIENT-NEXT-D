                    ...
                    <div className="col-span-3 relative lg:mt-20">
                        ...
                        <div className="lg:absolute top-0 overflow-hidden ">
                            <div className="flex flex-col justify-center items-center relative ">
                                ...
                                <motion.img initial={{ y: '200px' }} animate={{ y: '0px' }} transition={{ duration: 1 }} className={`${width <= 1500 ? 'w-full lg:mt-10' : 'w-3/4'} z-0    `} src='https://i.ibb.co.com/GPjnBCB/Tablet.png' alt="" />
                            </div>
                        </div>
                    </div>
                </div>
