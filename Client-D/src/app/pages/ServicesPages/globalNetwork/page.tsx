...
export const metadata = {
  ...
  description:
    "As a trusted partner, you'll gain exclusive access to top universities, scholarships, and the latest study opportunities for your students.",
  keywords: [
  ...
  alternates: {
    canonical: `${process.env.NEXT_PUBLIC_API_BASE_URL}/globalNetwork`,
  },
};
    ...
    return (
      <span className=" p-6   max-w-xl mx-auto">
        <ul className="list-disc pl-6 mb-4">
          <li>
            As a trusted partner, {`you'll`} gain exclusive access to top
            universities worldwide, including <strong>early admissions</strong>{" "}
            and <strong>exclusive scholarships</strong>.
          </li>
        </ul>
        <ul className="list-disc pl-6 mb-4">
          <li>
            We regularly update partners about new university partnerships and
            programs, keeping you informed of the best opportunities for your
            students.
          </li>
        </ul>
      </span>
